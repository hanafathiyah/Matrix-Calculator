...
public class InverseChecker {
  ...
  public void oneSolutionTest() throws Exception {
    ...
    SPLResult h0 = SPL.matriksInverseMethod(mat0);
    SPLResult h1 = SPL.matriksInverseMethod(mat1);
    SPLResult h2 = SPL.matriksInverseMethod(mat2);
    SPLResult h3 = SPL.matriksInverseMethod(mat3);
    ...
    Assert.assertEquals("x_1 = 1.0; x_2 = 1.0000000000000009; x_3 = 0.9999999999999991",h2.getStrResult());
  ...
  public void noSolutionTest(){
    ...
    try{
      SPLResult h4 = SPL.matriksInverseMethod(mat4);
